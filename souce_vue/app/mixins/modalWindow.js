class ModalWindow {
  ...
  openModal(text, header='Подтвердите действие', fixedHeight = true) {
    ...
    let modalWindow = `<div class="modalContainer">
                            <div class="modalWindow" fixedHeight="${fixedHeight}">
  ...
  showProperties(text, header='Свойства') {

    return new Promise((resolve) => {

      this.openModal(text, header, false);
